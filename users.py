...
test_users = {
    'eu_user': PkmUsers('eu_user', 'Euuser012', name='Иванов Андрей'),
    'eu_user2': PkmUsers('eu_user2', 'Euuser012', name='Иванов Второй'),
    'eu_user3': PkmUsers('eu_user3', 'Euuser012', name='Иванов Третий'),
